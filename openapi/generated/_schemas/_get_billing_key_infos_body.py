...
class GetBillingKeyInfosBody:
    ...
    """
    sort: Optional[BillingKeySortInput] = dataclasses.field(metadata={"serde_skip_if": lambda value: value is None})
    """정렬 조건
    
    미 입력 시 sortBy: TIME_TO_PAY, sortOrder: DESC 으로 기본값이 적용됩니다.
    """
    filter: Optional[BillingKeyFilterInput] = dataclasses.field(metadata={"serde_skip_if": lambda value: value is None})
    """조회할 빌링키 조건 필터
