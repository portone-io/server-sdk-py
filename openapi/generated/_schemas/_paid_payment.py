...
class PaidPayment:
    """결제 완료 상태 건"""
    status: Literal["PAID"] = dataclasses.field()
    """결제 건 상태"""
    ...
    """PG사 거래 아이디"""
    pg_response: Optional[str] = dataclasses.field(metadata={"serde_rename": "pgResponse", "serde_skip_if": lambda value: value is None})
    """PG사 거래 응답 본문"""
