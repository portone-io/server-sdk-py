...
from portone_server_sdk._openapi._schemas._get_cash_receipt_error import (
    GetCashReceiptError,
)
...
class GetCashReceiptByPaymentIdRequest(
    ApiRequest[
        CashReceipt,
        GetCashReceiptError,
        GetCashReceiptByPaymentIdParam,
        GetCashReceiptByPaymentIdQuery,
        Empty,
    ]
):
    method = "get"
