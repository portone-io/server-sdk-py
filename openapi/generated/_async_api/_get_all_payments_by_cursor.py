...
from portone_server_sdk._openapi._schemas._get_all_payments_by_cursor_body import (
    GetAllPaymentsByCursorBody,
)
from portone_server_sdk._openapi._schemas._get_all_payments_by_cursor_response import (
    GetAllPaymentsByCursorResponse,
)
from portone_server_sdk._openapi._schemas._get_all_payments_error import (
    GetAllPaymentsError,
)
...
class GetAllPaymentsByCursorRequest(
    ApiRequest[
        GetAllPaymentsByCursorResponse,
        GetAllPaymentsError,
        GetAllPaymentsByCursorParam,
        GetAllPaymentsByCursorQuery,
        GetAllPaymentsByCursorBody,
    ]
):
    method = "get"
