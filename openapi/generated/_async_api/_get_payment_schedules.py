...
from portone_server_sdk._openapi._schemas._get_payment_schedules_body import (
    GetPaymentSchedulesBody,
)
from portone_server_sdk._openapi._schemas._get_payment_schedules_error import (
    GetPaymentSchedulesError,
)
from portone_server_sdk._openapi._schemas._get_payment_schedules_response import (
...
from portone_server_sdk._openapi._schemas._payment_schedule_filter_input import (
    PaymentScheduleFilterInput,
)
from portone_server_sdk._openapi._schemas._payment_schedule_sort_input import (
...
class GetPaymentSchedulesRequest(
    ApiRequest[
        GetPaymentSchedulesResponse,
        GetPaymentSchedulesError,
        GetPaymentSchedulesParam,
