...
from portone_server_sdk._openapi._schemas._pre_register_payment_body import (
    PreRegisterPaymentBody,
)
from portone_server_sdk._openapi._schemas._pre_register_payment_error import (
    PreRegisterPaymentError,
)
from portone_server_sdk._openapi._schemas._pre_register_payment_response import (
...
class PreRegisterPaymentRequest(
    ApiRequest[
        PreRegisterPaymentResponse,
        PreRegisterPaymentError,
        PreRegisterPaymentParam,
        PreRegisterPaymentQuery,
        PreRegisterPaymentBody,
    ]
):
    method = "post"
