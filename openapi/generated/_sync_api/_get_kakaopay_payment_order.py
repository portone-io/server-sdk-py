...
from portone_server_sdk._openapi._schemas._get_kakaopay_payment_order_error import (
    GetKakaopayPaymentOrderError,
)
from portone_server_sdk._openapi._schemas._get_kakaopay_payment_order_response import (
...
class GetKakaopayPaymentOrderRequest(
    ApiRequest[
        GetKakaopayPaymentOrderResponse,
        GetKakaopayPaymentOrderError,
        GetKakaopayPaymentOrderParam,
        GetKakaopayPaymentOrderQuery,
        Empty,
    ]
):
    method = "get"
