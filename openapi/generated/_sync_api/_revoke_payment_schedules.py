...
from portone_server_sdk._openapi._schemas._revoke_payment_schedules_body import (
    RevokePaymentSchedulesBody,
)
from portone_server_sdk._openapi._schemas._revoke_payment_schedules_error import (
    RevokePaymentSchedulesError,
)
from portone_server_sdk._openapi._schemas._revoke_payment_schedules_response import (
...
class RevokePaymentSchedulesRequest(
    ApiRequest[
        RevokePaymentSchedulesResponse,
        RevokePaymentSchedulesError,
        RevokePaymentSchedulesParam,
        RevokePaymentSchedulesQuery,
        RevokePaymentSchedulesBody,
    ]
):
    method = "delete"
