...
from portone_server_sdk._openapi._schemas._delete_billing_key_error import (
    DeleteBillingKeyError,
)
from portone_server_sdk._openapi._schemas._delete_billing_key_response import (
...
class DeleteBillingKeyRequest(
    ApiRequest[
        DeleteBillingKeyResponse,
        DeleteBillingKeyError,
        DeleteBillingKeyParam,
        DeleteBillingKeyQuery,
        Empty,
    ]
):
    method = "delete"
